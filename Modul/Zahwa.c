...
void displayMenuWithGraphics() {
    ...
    MenuNodeZahwa* menuHead = NULL;
    
    // Node Play
    MenuNodeZahwa* node1 = (MenuNodeZahwa*)malloc(sizeof(MenuNodeZahwa));
    node1->menuOption = "Play";
    node1->highlightColor = MY_DARK_PINK;
    node1->next = NULL;
    menuHead = node1;
    
    // Node Info
    MenuNodeZahwa* node2 = (MenuNodeZahwa*)malloc(sizeof(MenuNodeZahwa));
    ...
    // Node Settings
    MenuNodeZahwa* node3 = (MenuNodeZahwa*)malloc(sizeof(MenuNodeZahwa));
    ...
    // Node Exit
    MenuNodeZahwa* node4 = (MenuNodeZahwa*)malloc(sizeof(MenuNodeZahwa));
    ...
    while (!WindowShouldClose()) {
        ...
        MenuNodeZahwa* current = menuHead;
        int index = 0;
        while (current != NULL) {
